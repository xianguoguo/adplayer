...
public class ScrollTextViewWrapper extends AppCompatTextView {
    ...
    public ScrollTextViewWrapper(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollTextViewWrapper(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.ScrollTextViewWrapper);
        scrollTextColor = attributes.getColor(R.styleable.ScrollTextViewWrapper_scrollTextColor, Color.WHITE);
        mSpeed = attributes.getInt(R.styleable.ScrollTextViewWrapper_scrollSpeed, NORMAL);
        setSingleLine(true);
        mPaint = getPaint();
